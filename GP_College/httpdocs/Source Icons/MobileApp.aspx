<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MobileApp.aspx.cs" Inherits="MobileApp" %>
  ...
  <div class="container">
	...
	width:100%;">
       ...
       <td style="vertical-align:top;padding-top:10px; background-color:#F6F6F6;>
           ...
           <asp:Label ID="Mail" CssClass="EMail" runat="server" Text="E-Mail"></asp:Label>
       </td>
       </tr>
       <tr>
       ...
       Security settings  
        ...
        Notification
           ...
           <a href="http://egyptworldwide.com/MobileApp.rar" target="_blank">
           
           <img src="images/setup pic.png"  width="100%"/>
           </a>
           </td>
       </tr>
       </table>
