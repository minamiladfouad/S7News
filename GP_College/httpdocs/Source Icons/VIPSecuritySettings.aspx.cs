...
public partial class VIPSecuritySettings : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UserName_New.Text = Info.Rows[0][5].ToString();
    ...
    {
        Services.Services webservice = new Services.Services();
        webservice.Edit_Private_Security(int.Parse(Session["ID"].ToString()), 1, UserName_New.Text, Password_New.Text, short.Parse(Questions.SelectedIndex.ToString()), SecretA.Text);
