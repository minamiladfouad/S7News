<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VIPRegistration.aspx.cs" Inherits="VIPRegistration" %>
	...
	width:100%;">
      ...
      <table width="100%">
       ...
       <td>
            ...
            ControlToValidate="LastName" ErrorMessage="رجاء ادخال الاسم الاول" 
               ForeColor="Red"></asp:RequiredFieldValidator>
                 
       &nbsp;
                 
       <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" 
            ControlToValidate="FirstName" ErrorMessage="رجاء ادخال الاسم الثانى" 
               ForeColor="Red"></asp:RequiredFieldValidator>
                
     
      </td>  
      <td>
       <asp:TextBox ID="FirstName" runat="server" Height="20px" Width="48px"></asp:TextBox>
       <asp:Label ID="label14" runat="server" Text="الاسم الاول" CssClass="text"></asp:Label>
       <asp:TextBox ID="LastName" runat="server" Height="20px" Width="48px"></asp:TextBox>
       <asp:Label ID="label15" runat="server" Text="الاسم الثانى" CssClass="text"></asp:Label>
       ...
       <td>
        <asp:Label ID="Label10" runat="server" Text="الاسم بالكامل" CssClass="text"></asp:Label>
       </td>
       </tr>
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
        ControlToValidate="PhoneNumber" ErrorMessage="رجاء ادخال رقم التليفون" ForeColor="Red"></asp:RequiredFieldValidator>
           <asp:RegularExpressionValidator ID="regphonenum" runat="server"     
                                    ErrorMessage="رجاء ادخال الرقم بشكل صحيح" 
                                    ControlToValidate="PhoneNumber"     
                                    ValidationExpression="^([0]{1})([01245689]{1})([0-9]{9})$" />
             
                    
       <asp:TextBox ID="PhoneNumber" runat="server" Height="20px" Width="231px"></asp:TextBox>
       </td>
       <td>
        <asp:Label ID="Label11" runat="server" Text="رقم التليفون" CssClass="text"></asp:Label>
       </td>
       </tr>
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
        ControlToValidate="Address" ErrorMessage="رجاء ادخال العنوان" ForeColor="Red"></asp:RequiredFieldValidator>
       <asp:TextBox ID="Address" runat="server" Height="20px" Width="231px"></asp:TextBox>
       </td>
       <td>
        <asp:Label ID="Label12" runat="server" Text="العنوان" CssClass="text"></asp:Label>
       </td>
       </tr>
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
        ControlToValidate="Job" ErrorMessage="رجاء ادخال الوظيفة" ForeColor="Red"></asp:RequiredFieldValidator>
       <asp:TextBox ID="Job" runat="server" Height="20px" Width="231px"></asp:TextBox>
       </td>
       <td>
        <asp:Label ID="Label13" runat="server" Text="الوظيفة" CssClass="text"></asp:Label>
       </td>
       </tr>
      <tr>
        ...
        <asp:RangeValidator ID="RangeValidator3" runat="server" 
            ...
            <td>
             <asp:TextBox ID="Year" runat="server" Height="20px" Width="65px"></asp:TextBox>
       ...
       <asp:Label ID="Label8" runat="server" Text="شهر" CssClass="text"></asp:Label>
            ...
            <td>
            <asp:TextBox ID="Day" runat="server" Height="19px" Width="36px"></asp:TextBox>
